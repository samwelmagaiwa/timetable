...
@Component({
  ...
  template: `
    <div className="container">
      ...
      <!-- Stats Cards -->
      <div className="grid grid-3" style="margin-bottom: 2rem;">
        <div className="card" style="text-align: center; background: linear-gradient(135deg, #dbeafe, #bfdbfe); border: none;">
        ...
        <div className="card" style="text-align: center; background: linear-gradient(135deg, #d1fae5, #a7f3d2); border: none;">
          <div style="font-size: 2.5rem; margin-bottom: 0.5rem;">📋</div>
          <h2 style="font-size: 2rem; color: #065f46; margin: 0;">{{ scheduleCount }}</h2>
          <p style="color: #10b981; margin-top: 0.5rem;">Schedules Created</p>
        </div>

        <div className="card" style="text-align: center; background: linear-gradient(135deg, #fef3c7, #fde68a); border: none;">
          <div style="font-size: 2.5rem; margin-bottom: 0.5rem;">🌙</div>
      ...
      <div className="card">
        ...
        <div className="grid grid-2" style="margin-top: 1rem;">
          <a routerLink="/schedule/generate" className="card" style="text-decoration: none; color: inherit; display: block; transition: transform 0.2s;"
          ...
          <a routerLink="/staff" className="card" style="text-decoration: none; color: inherit; display: block; transition: transform 0.2s;"
             onMouseEnter="this.style.transform='translateY(-2px)'" onMouseLeave="this.style.transform='translateY(0)'">
      ...
      <!-- Recent Schedules -->
      <div className="card" style="margin-top: 1.5rem;">
        <div className="card-header">📋 Recent Schedules</div>
        ...
        <div *ngFor="let schedule of recentSchedules" className="card" style="background: #f8fafc; margin-top: 1rem;">
          <div style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <span className="badge" [ngClass]="schedule.is_locked ? 'badge-night' : 'badge-morning'">
